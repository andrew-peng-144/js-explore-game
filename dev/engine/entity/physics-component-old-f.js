...
1. need a Fixed-grid based collision detection among PCs.
May consolidate all PCs into a single list/set instead of kinematic and statics

Solidity may be handled outside, by the user, in their custom collision-resolution methods.
//
...
function updateAll() {
    ...
    //return;
    //do naive O(n^2) detection for now for broad phase
    /**
